...
public class GamePanel extends JPanel implements Runnable {
	...
	Thread gameThread; // Faz com que um processo fique ocorrendo n vezes por segundo, atualizando a
						// tela;
	...
	public GamePanel() {
		...
		this.setDoubleBuffered(true); // melhora o desempenho da renderização gráfica em aplicações que envolvem
										// animações ou renderizações frequentes de tela
	...
	public void paintComponent(Graphics g) {
		...
		player.draw(g2);
		g2.dispose(); // metodo essencial para a gestão eficiente dos recursos, usado para liberar
						// qualquer recurso do sistema que o objeto estiver usando;
