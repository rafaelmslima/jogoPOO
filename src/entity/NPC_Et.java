...
public class NPC_Et extends Entity {
    ...
    public void getImage() {
        up1 = setup("/npc/et_up_1");
        up2 = setup("/npc/et_up_2");
        down1 = setup("/npc/et_down_1");
        down2 = setup("/npc/et_down_2");
        left1 = setup("/npc/et_left_1");
        left2 = setup("/npc/et_left_2");
        right1 = setup("/npc/et_right_1");
        right2 = setup("/npc/et_right_2");
    }
