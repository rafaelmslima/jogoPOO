...
public class NPC_Princesa extends Entity {
    public NPC_Princesa(GamePanel gp) {
        super(gp);
    ...
    public void getImage() {
        up1 = setup("/npc/princesa_up_1");
        up2 = setup("/npc/princesa_up_2");
        down1 = setup("/npc/princesa_down_1");
        down2 = setup("/npc/princesa_down_2");
        left1 = setup("/npc/princesa_left_1");
        left2 = setup("/npc/princesa_left_2");
        right1 = setup("/npc/princesa_right_1");
        right2 = setup("/npc/princesa_right_2");
    }
