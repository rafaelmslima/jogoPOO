...
public class NPC_Esqueleto extends Entity {
    public NPC_Esqueleto(GamePanel gp) {
        super(gp);
    ...
    public void getImage() {
        up1 = setup("/npc/esqueleto_up_1");
        up2 = setup("/npc/esqueleto_up_2");
        down1 = setup("/npc/esqueleto_down_1");
        down2 = setup("/npc/esqueleto_down_2");
        left1 = setup("/npc/esqueleto_left_1");
        left2 = setup("/npc/esqueleto_left_2");
        right1 = setup("/npc/esqueleto_right_1");
        right2 = setup("/npc/esqueleto_right_2");
    }
