...
public class NPC_Guerreiro extends Entity {
    ...
    public void getImage() {
        up1 = setup("/npc/guerreiro_up_1");
        up2 = setup("/npc/guerreiro_up_2");
        down1 = setup("/npc/guerreiro_down_1");
        down2 = setup("/npc/guerreiro_down_2");
        left1 = setup("/npc/guerreiro_left_1");
        left2 = setup("/npc/guerreiro_left_2");
        right1 = setup("/npc/guerreiro_right_1");
        right2 = setup("/npc/guerreiro_right_2");
    }
