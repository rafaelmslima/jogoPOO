...
public class NPC_Templario extends Entity {
    public NPC_Templario(GamePanel gp) {
        super(gp);
    ...
    public void getImage() {
        up1 = setup("/npc/templario_up_1");
        up2 = setup("/npc/templario_up_2");
        down1 = setup("/npc/templario_down_1");
        down2 = setup("/npc/templario_down_2");
        left1 = setup("/npc/templario_left_1");
        left2 = setup("/npc/templario_left_2");
        right1 = setup("/npc/templario_right_1");
        right2 = setup("/npc/templario_right_2");
    }
