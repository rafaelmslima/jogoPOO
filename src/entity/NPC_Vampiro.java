...
public class NPC_Vampiro extends Entity {
    ...
    public void getImage() {
        up1 = setup("/npc/vampiro_up_1");
        up2 = setup("/npc/vampiro_up_2");
        down1 = setup("/npc/vampiro_down_1");
        down2 = setup("/npc/vampiro_down_2");
        left1 = setup("/npc/vampiro_left_1");
        left2 = setup("/npc/vampiro_left_2");
        right1 = setup("/npc/vampiro_right_1");
        right2 = setup("/npc/vampiro_right_2");
    }
